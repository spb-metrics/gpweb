...
var imageFilesPath = "estilo/rondon/imagens/icones/";
...
var WeekDayName1 = ["Domingo", "Segunda", "Ter&ccedil;a", "Quarta", "Quinta", "Sexta", "S&aacute;bado"];
var WeekDayName2 = ["Segunda", "Ter&ccedil;a", "Quarta", "Quinta", "Sexta", "S&aacute;bado", "Domingo"];
...
function RenderCssCal(bNewCal)
{
	...
	if (Cal.ShowTime === true)
	{
		...
		vCalTime += "<tr><td colspan='7' style=\"text-align:center;\"><input style='width:60px;font-size:12px;' onClick='javascript:closewin(\"" + Cal.Ctrl + "\");'  type=\"button\" value=\"OK\">&nbsp;<input style='width:60px;font-size:12px;' onClick='javascript: winCal.style.visibility = \"hidden\"' type=\"button\" value=\"Cancelar\"></td></tr>";
	}
	...
	if( (ypos - CalPosOffsetY) > calHeight)
	{
		ypos = ypos - calHeight;
	}
